...
// Get the Instance ID token//
        ...
        lock_state_btn.setOnClickListener(v -> {
                        ...
                        if(byteCount > 0)
                        {
                            ...
                            handler.post(new Runnable()
                            {
                               public void run()
                               {
                                    ...
                                    {
                                        if(Flag) {
                                            Toast.makeText(getApplicationContext(), "Locked Successfully!!", Toast.LENGTH_LONG).show();
                                        }
    ...
    public boolean BTconnect()
    {
        ...
        try
        {
            ...
            Toast.makeText(getApplicationContext(),
                    "Connected Successfully!", Toast.LENGTH_LONG).show();
            connected = true;
        }
        catch(IOException e)
        {
